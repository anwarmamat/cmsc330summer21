...
You can also manually submit to [Gradescope](https://www.gradescope.com/courses/272105/assignments/1367248).  You may only submit the **lexer.ml** and **parser.ml** files.  To test locally, run `dune runtest -f`.
